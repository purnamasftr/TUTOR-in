...
<body>
	...
	<header id="home">
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('<?php echo e(URL::to('/')); ?>/../web-tutorin-fix/img/background11.jpg');">
			...
			<div class="container">
				...
				<div class="navbar-header">
					...
					<div class="navbar-brand">
						<a href="index.html">
							<img class="logo" src="<?php echo e(URL::to('/')); ?>/../web-tutorin-fix/img/logo1.png" alt="logo">
							<img class="logo-alt" src="<?php echo e(URL::to('/')); ?>/../web-tutorin-fix/img/logo1-alt.png" alt="logo">
						</a>
					</div>
					<!-- /Logo -->
				...
				<div class="row">
					...
					<div class="col-md-10 col-md-offset-1">
						<div class="home-content">
							...
							<button onclick="window.location='<?php echo e(route('pages.login')); ?>'" class="white-btn">Sign Up</button>
	...
	<div id="numbers" class="section sm-padding">
		...
		<!-- Background Image -->
		<div class="bg-img" style="background-image: url('<?php echo e(URL::to('/')); ?>/../web-tutorin-fix/img/background2.jpg');">
			<div class="overlay"></div>
		</div>
		<!-- /Background Image -->
